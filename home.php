...
<body>
 <div class="navbar navbar-inverse navbar-fixed-top"><!--*****Header******-->
      ...
      <div class=" navbar-inner" style="background: #000;">
        ...
        <span class="icon-bar"></span>
          ...
          <a class="brand" href="#"><b>Restaurant System</b></a>
 ...
 <div class="container">
  ...
  <input type="text" id="product" required  autocomplete="off" placeholder="Enter Items Name" style="width:300px;height: 30px;"><br>
  <div class="ui-widget">
  <input type="hidden" name="product" id="product_hidden" required class="form-control" autocomplete="off" placeholder="Enter Items Name" style="width:300px;height: 30px;">
</div>
   <input type="hidden" name="expire_date" id="date_hidden" required class="form-control" autocomplete="off" placeholder="Enter Items Name" style="width:300px;height: 30px;">
